FINAL_INFO = """🎞️ Плёнка судьбы: твоя профессия в XX веке
...
Доволен своим выбором? Если хочешь удостоверится, то проходи наш чат - бот ещё раз и убедись точно в своей профессии! 🔮"""
